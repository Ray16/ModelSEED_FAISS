#!/usr/bin/env python
"""
Step 0 — Generate reaction SMILES and RXNFP fingerprints for all ModelSEED reactions.

Inputs:  ModelSEEDDatabase/
Outputs: rxn_data.csv, rxn_fingerprints.npy
"""
...
def generate_rxn_data(compounds_dict, reactions_dict):
    ...
    Returns
    -------
    rxn_data_list : list[OrderedDict]
...
def write_rxn_csv(rxn_data_list):
    """Write *rxn_data_list* to :pydata:`config.RXN_DATA_CSV`."""
